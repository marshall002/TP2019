                    ...
                    <div class="row clearfix">
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            <div class="card">
                                ...
                                </div>  <asp:Label ID="txtmostrarcod" runat="server" class="form-control" Enabled="false"></asp:Label>
                                ...
                                <div class="body table-responsive ">
                                    <asp:GridView ID="gvRegistrarPago" class="table table-bordered table-hover" runat="server" AutoGenerateColumns="False" DataKeyNames="PK_ICP_Cod, DCP_FechaHoraRealizada, ICP_NFisio, ICP_NNutri, VCP_Estado_Pago" EmptyDataText="No tiene pagos registradas" ShowHeaderWhenEmpty="True" OnRowCommand="gvRegistrarPago_RowCommand" OnSelectedIndexChanged="gvRegistrarPago_SelectedIndexChanged">
                                        <Columns>
                                            ...
                                            <%--                                    <asp:TemplateField>
                                        <ItemTemplate>
                                            <asp:Button ID="btnGetCodigo" Text="Ver" class="btn btn-danger"
                                                CommandArgument="<%# Container.DataItemIndex %>" CommandName="Ver"
                                                runat="server" data-toggle="modal" data-target="#agregarcliente" />
                                        </ItemTemplate>
                                    </asp:TemplateField>--%>
                        ...
                        <div class="modal-body">
                            <div class="input-group ">
                                <div class="form-line">
                                    <label for="textComprobante">Comprobante:</label><br />
                                    <div class="col-lg-4">
                                        <asp:Image ID="Image1" Width="250" Height="200" runat="server" CssClass="form-control"></asp:Image>
                                    </div>
                                </div>
                                <span class="input-group-addon">
                                    <i></i>
